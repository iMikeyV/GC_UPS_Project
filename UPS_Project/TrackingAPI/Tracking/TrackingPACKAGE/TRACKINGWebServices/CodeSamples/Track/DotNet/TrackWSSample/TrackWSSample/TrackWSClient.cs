      ...
      static void Main()
        {
            try
            {
                ...
                upssUsrNameToken.Username = "imikey30";
                upssUsrNameToken.Password = "NicolaS!@#321";
                ...
                tr.Request = request;
                tr.InquiryNumber = "1Z808A090391078003";
                ...
                Console.WriteLine("Testing array @ 1" + trackResponse.Shipment[1].Service.Description);
                //Console.WriteLine("Testing array @ 2" + trackResponse.Shipment[2].Service.Description);

                //Console.WriteLine("Testing array @ 3" + trackResponse.Shipment[3].Service.Description);
                Console.ReadKey();
            }
